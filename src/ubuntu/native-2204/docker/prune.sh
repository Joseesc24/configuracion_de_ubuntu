...
print_title "01/05 - Removiendo Todos Los Contenedores De Docker"
...
print_title "02/05 - Removiendo Todas Las Imagenes De Docker"
...
print_title "03/05 - Removiendo Todos Los Volumenes De Docker"
...
print_title "04/05 - Removiendo Todas Las Redes De Docker"

docker network prune -f

print_title "05/05 - Removiendo Archivos Residuales De Docker"
